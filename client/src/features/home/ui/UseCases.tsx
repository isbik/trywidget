    ...
    const items = [
        {
            profession: 'Блогер',
            description:
                'Блогеры могут использовать видео-виджеты для показа своих видео-блогов на своих веб-сайтах и в социальных сетях. Они также могут использовать видео-виджеты для создания коллекции видеороликов, которые они могут продавать или предоставлять доступ к ним за подписку.',
            videoUrl: '/static/landing/videos/блогер.mp4',
        },
        {
            profession: 'Учителя',
            description:
                'Учителя могут использовать видео-виджеты для проведения онлайн-уроков и показа обучающих видеороликов на своих веб-сайтах. Они также могут использовать видео-виджеты для создания библиотеки обучающих видеороликов, которые ученики могут просматривать в любое время.',
            videoUrl: '/static/landing/videos/учитель.mp4',
        },
        // {
        //     profession: 'Фотограф',
        //     description:
        //         'Фотографы могут использовать видео-виджеты для создания слайд-шоу своих фотографий, которые они могут показывать на своих веб-сайтах и в социальных сетях. Они также могут использовать видео-виджеты для создания обучающих видеороликов, которые помогут своим клиентам улучшить свои навыки фотографирования.',
        //     // TODO
        //     videoUrl: '/static/landing/videos/учитель.mp4',
        // },
        // {
        ...
        },
        {
            ...
            description:
                'Фитнес-тренер может использовать видео-виджет, чтобы делиться тренировками, демонстрациями упражнений и мотивационными сообщениями. Это может помочь клиентам оставаться вовлеченными в достижение своих целей в фитнесе и обеспечить удобный способ доступа к тренировкам из дома.',
        ...
        },
        {
            ...
            description:
                'Лайф-коуч может использовать видео-виджет для обмена мотивационными сообщениями, коучинговыми сессиями и историями успеха клиентов. Это может помочь укрепить доверие с потенциальными клиентами и дать представление о процессе коучинга.',
